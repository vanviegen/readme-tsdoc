...
npx readme-tsdoc --search "Auto-generated docs from"
```
...
The following is auto-generated from `readme-tsdoc.js`:
### generateMarkdownDoc · function

Generate markdown documentation for a TypeScript file using TypeScript compiler API

**Signature:** `(filePath: string, headingPrefix: string) => Promise<string>`
...
**Signature:** `(readmePath: string, searchPhrase: string) => Promise<void>`
